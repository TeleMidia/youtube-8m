...
def main(_):
  ...
  if FLAGS.wav_file:
    ...
    if os.path.exists(FLAGS.csv_file):
        print(f'Csv {FLAGS.csv_file} already exists! Skipping!')
        #quit
    #'/mnt/HDSDE/audio/--dNe5FgcIc.wav'#'/mnt/HDSDE/audio/059u6SSMQEU.wav'
    print('\n\n',wav_file,'\n\n')
  else:
  ...
  with tf.Graph().as_default(), tf.Session() as sess:
    ...
    if csv_writer:
      data = np.array(postprocessed_batch)
      data = np.average(data, axis=0)
      csv_writer.writerow(data)
      print('\n\nExtracted audio features with success!\n\n')
    else:
      # print(postprocessed_batch)
      # print(len(postprocessed_batch))
      #for i in postprocessed_batch:
      #  print(len(i))
